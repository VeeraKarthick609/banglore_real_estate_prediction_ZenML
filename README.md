...
**Problem statement**: This project aims to predict house prices in Bangalore using machine learning. The dataset used for this project is available on Kaggle [here](https://www.kaggle.com/datasets/bandhansingh/banglore-house-price-data).
